...
class DeleteAccountPage(StyledCanvasFrame):
    def __init__(self, parent: tk.Widget, controller: App) -> None:
        ...
        self.select_prof = tk.Radiobutton(self, text="Professor", font=FONT_BUTTON, bg='white', value="prof", variable=self.account_type ,command= self.show_accounts )
        self.select_TA = tk.Radiobutton(self, text="TA", font=FONT_BUTTON,bg='white', value="TA", variable=self.account_type ,command= self.show_accounts)
    ...
    def show_accounts(self) -> None:
        ...
        self.user_list = tk.Listbox(self.user_list_frame, width=17, height=5, font=("Arial", 12, "bold"), yscrollcommand=scrollbar.set)
